...
CORPUS = [
    ...
    {"name": "[Group] Show Name - 05v2 [BDRip 1080p].mkv", "episodes": [5], "is_tv": True,
    ...
    {"name": "[Erai-raws] One Piece - 1071 [1080p][HEVC].mkv", "episodes": [1071], "is_tv": True,
     "note": "C-2: 4-digit absolute episode (long-running anime)"},
    {"name": "[Judas] Detective Conan - 1000 [1080p][HEVC].mkv", "episodes": [1000], "is_tv": True,
    ...
    {"name": "One Piece - 720.mkv", "episodes": [720],
     "note": "P-H2: a bare dash number equal to a resolution value is still an episode"},
    {"name": "[Group] One Piece - 1080 [x264].mkv", "episodes": [1080],
