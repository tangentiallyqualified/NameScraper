...
''',
    ...
    with pytest.raises(ValueError) as exc_info:
        _render_human.load_cycle_edge_classifications(synthetic_repo, _engine_cycle_graph())
...
''',
    ...
    classifications = _render_human.load_cycle_edge_classifications(
        synthetic_repo,
        _engine_cycle_graph(),
    )

    rendered = _render_human.render_classified_cycle_map(classifications)
