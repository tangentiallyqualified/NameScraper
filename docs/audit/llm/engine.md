<!-- Generated at commit 7d129cb; do not edit. regenerate: scripts\audit.cmd --fast -->
...
- `TVScanner` — Scans a TV series folder and builds PreviewItems using TMDB data. (used by: plex_renamer.app.controllers.media_controller, plex_renamer.engine, plex_renamer.engine._batch_orchestrators, plex_renamer.engine._core, plex_renamer.engine.models)
