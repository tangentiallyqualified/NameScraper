...
- `plex_renamer/app/services/tv_library_discovery_service.py` — fan-in 3, fan-out 2, LOC 194
...
- `plex_renamer/app/controllers/media_controller.py` — fan-in 2, fan-out 19, LOC 545
