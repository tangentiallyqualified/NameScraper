...
- `plex_renamer/app/services/episode_mapping_service.py` — fan-in 5, fan-out 6, LOC 476
...
- `plex_renamer/app/services/_episode_metadata.py` — fan-in 1, fan-out 2, LOC 39
