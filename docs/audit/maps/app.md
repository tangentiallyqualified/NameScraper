...
- `plex_renamer/app/models/state_models.py` — fan-in 4, fan-out 0, LOC 258
- `plex_renamer/app/services/__init__.py` — fan-in 3, fan-out 7, LOC 19
- `plex_renamer/app/services/automux_service.py` — fan-in 5, fan-out 5, LOC 190
- `plex_renamer/app/services/cache_service.py` — fan-in 3, fan-out 3, LOC 274
- `plex_renamer/app/services/command_gating_service.py` — fan-in 10, fan-out 4, LOC 268
- `plex_renamer/app/services/episode_mapping_service.py` — fan-in 5, fan-out 4, LOC 489
...
- `plex_renamer/app/services/tv_library_discovery_service.py` — fan-in 3, fan-out 3, LOC 207

### Support
- `plex_renamer/app/controllers/__init__.py` — fan-in 1, fan-out 5, LOC 24
- `plex_renamer/app/controllers/_controller_event_helpers.py` — fan-in 2, fan-out 5, LOC 91
...
- `plex_renamer/app/controllers/_match_state_helpers.py` — fan-in 1, fan-out 2, LOC 192
...
- `plex_renamer/app/controllers/_queue_history_helpers.py` — fan-in 1, fan-out 4, LOC 74
...
- `plex_renamer/app/controllers/_tv_state_helpers.py` — fan-in 2, fan-out 4, LOC 83
- `plex_renamer/app/controllers/media_controller.py` — fan-in 2, fan-out 20, LOC 539
- `plex_renamer/app/controllers/queue_controller.py` — fan-in 2, fan-out 7, LOC 274
...
- `plex_renamer/app/services/_tv_library_classification.py` — fan-in 1, fan-out 3, LOC 347
- `plex_renamer/app/services/episode_projection_cache.py` — fan-in 1, fan-out 3, LOC 153
- `plex_renamer/app/services/metadata_service.py` — fan-in 2, fan-out 7, LOC 403
- `plex_renamer/app/services/movie_library_discovery_service.py` — fan-in 2, fan-out 2, LOC 124
