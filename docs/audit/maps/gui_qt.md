...
- `plex_renamer/gui_qt/widgets/busy_overlay.py` — fan-in 3, fan-out 2, LOC 148
...
- `plex_renamer/gui_qt/_main_window_tabs.py` — fan-in 1, fan-out 5, LOC 137
- `plex_renamer/gui_qt/_main_window_tmdb.py` — fan-in 1, fan-out 2, LOC 217
- `plex_renamer/gui_qt/app.py` — fan-in 1, fan-out 2, LOC 161
- `plex_renamer/gui_qt/main_window.py` — fan-in 1, fan-out 24, LOC 376
...
- `plex_renamer/gui_qt/widgets/_job_detail_poster.py` — fan-in 1, fan-out 3, LOC 131
...
- `plex_renamer/gui_qt/widgets/_media_workspace_refresh.py` — fan-in 1, fan-out 5, LOC 175
- `plex_renamer/gui_qt/widgets/_media_workspace_roster.py` — fan-in 1, fan-out 6, LOC 231
- `plex_renamer/gui_qt/widgets/_media_workspace_state.py` — fan-in 1, fan-out 4, LOC 261
- `plex_renamer/gui_qt/widgets/_media_workspace_sync.py` — fan-in 1, fan-out 2, LOC 87
- `plex_renamer/gui_qt/widgets/_media_workspace_ui.py` — fan-in 1, fan-out 4, LOC 162
...
- `plex_renamer/gui_qt/widgets/_roster_model.py` — fan-in 2, fan-out 9, LOC 404
- `plex_renamer/gui_qt/widgets/_settings_automux_page.py` — fan-in 1, fan-out 5, LOC 332
- `plex_renamer/gui_qt/widgets/_settings_metadata_page.py` — fan-in 1, fan-out 3, LOC 163
- `plex_renamer/gui_qt/widgets/_settings_tab_actions.py` — fan-in 1, fan-out 2, LOC 222
- `plex_renamer/gui_qt/widgets/_settings_tab_sections.py` — fan-in 1, fan-out 6, LOC 388
...
- `plex_renamer/gui_qt/widgets/_work_panel.py` — fan-in 1, fan-out 13, LOC 923
...
- `plex_renamer/gui_qt/widgets/history_tab.py` — fan-in 1, fan-out 5, LOC 180
- `plex_renamer/gui_qt/widgets/job_detail_panel.py` — fan-in 1, fan-out 6, LOC 634
- `plex_renamer/gui_qt/widgets/match_picker_dialog.py` — fan-in 1, fan-out 3, LOC 165
- `plex_renamer/gui_qt/widgets/media_workspace.py` — fan-in 1, fan-out 12, LOC 383
- `plex_renamer/gui_qt/widgets/queue_tab.py` — fan-in 1, fan-out 5, LOC 220
- `plex_renamer/gui_qt/widgets/scan_progress.py` — fan-in 2, fan-out 4, LOC 561
- `plex_renamer/gui_qt/widgets/settings_tab.py` — fan-in 1, fan-out 6, LOC 267
