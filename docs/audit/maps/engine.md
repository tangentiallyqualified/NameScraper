...
- `plex_renamer/engine/_core.py` — fan-in 0, fan-out 7, LOC 55
...
- `plex_renamer/engine/_discovery_ports.py` — fan-in 3, fan-out 0, LOC 41
...
- `plex_renamer/engine/_movie_scanner.py` — fan-in 6, fan-out 9, LOC 468
...
- `plex_renamer/engine/_scan_runtime.py` — fan-in 6, fan-out 2, LOC 44
- `plex_renamer/engine/_state.py` — fan-in 7, fan-out 0, LOC 44
- `plex_renamer/engine/_tv_scanner.py` — fan-in 3, fan-out 12, LOC 356
- `plex_renamer/engine/episode_assignments.py` — fan-in 9, fan-out 0, LOC 488
- `plex_renamer/engine/matching.py` — fan-in 4, fan-out 7, LOC 639
- `plex_renamer/engine/models.py` — fan-in 31, fan-out 5, LOC 481

### Support
- `plex_renamer/engine/_audio_codecs.py` — fan-in 2, fan-out 0, LOC 67
- `plex_renamer/engine/_batch_orchestrators.py` — fan-in 2, fan-out 20, LOC 1376
- `plex_renamer/engine/_batch_tv_episode_claims.py` — fan-in 1, fan-out 5, LOC 174
- `plex_renamer/engine/_batch_tv_match_policy.py` — fan-in 1, fan-out 4, LOC 173
- `plex_renamer/engine/_batch_tv_season_merge.py` — fan-in 1, fan-out 4, LOC 332
- `plex_renamer/engine/_batch_types.py` — fan-in 1, fan-out 2, LOC 39
...
- `plex_renamer/engine/_provider_scan_guard.py` — fan-in 1, fan-out 3, LOC 37
- `plex_renamer/engine/_queue_bridge.py` — fan-in 2, fan-out 4, LOC 242
- `plex_renamer/engine/_season_map_validation.py` — fan-in 2, fan-out 1, LOC 85
