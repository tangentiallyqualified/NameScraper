...
- `plex_renamer/engine/_scan_runtime.py` — fan-in 6, fan-out 2, LOC 41
...
- `plex_renamer/engine/matching.py` — fan-in 4, fan-out 5, LOC 641
- `plex_renamer/engine/models.py` — fan-in 30, fan-out 4, LOC 481

### Support
- `plex_renamer/engine/_audio_codecs.py` — fan-in 2, fan-out 0, LOC 67
- `plex_renamer/engine/_batch_orchestrators.py` — fan-in 2, fan-out 18, LOC 1394
...
- `plex_renamer/engine/_season_map_validation.py` — fan-in 1, fan-out 1, LOC 85
...
- `plex_renamer/engine/_tv_score_fallback.py` — fan-in 1, fan-out 2, LOC 37
