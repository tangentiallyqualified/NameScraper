...
class SettingsTab(QScrollArea):
    ...
    def _on_fallback_toggled(self, checked: bool) -> None:
        self._actions_coordinator.on_fallback_toggled(checked)

    def _on_id_tag_routing_toggled(self, checked: bool) -> None:
        self._actions_coordinator.on_id_tag_routing_toggled(checked)
